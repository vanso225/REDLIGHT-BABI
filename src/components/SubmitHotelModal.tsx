      ...
      {isOpen && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6 md:p-10 pointer-events-auto">
          ...
          <motion.div 
            ...
            className="relative w-full max-w-lg bg-zinc-950 border border-zinc-800 rounded-[24px] overflow-hidden shadow-2xl flex flex-col max-h-[90vh]"
          >
            {!submitted ? (
              <>
                <div className="p-6 md:p-8 border-b border-white/5 flex justify-between items-center bg-zinc-950 sticky top-0 z-20">
                  ...
                  <button 
                    onClick={onClose} 
                    className="p-3 bg-[#1a1a1a] rounded-full text-zinc-400 hover:text-white hover:bg-zinc-800 transition-all border border-white/5 active:scale-90"
                    title="Fermer"
                  >
                    <X size={24} />
                  </button>
                ...
                <form onSubmit={handleSubmit} className="flex-1 p-6 md:p-8 space-y-8 overflow-y-auto custom-scrollbar">
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <div className="relative">
                          <select 
                            required
                            className="w-full bg-[#1a1a1a] border border-[#e11d48]/20 rounded-[12px] p-4 text-base text-white focus:outline-none focus:ring-2 focus:ring-[#e11d48]/50 focus:border-[#e11d48] transition-all appearance-none cursor-pointer"
                    ...
                    <div className="p-5 bg-[#1a1a1a]/50 border border-[#e11d48]/10 rounded-[12px] space-y-4">
                ...
                <div className="p-6 md:p-8 border-t border-white/5 bg-zinc-950">
                  ...
                  <p className="text-[9px] text-zinc-600 text-center mt-4 uppercase font-bold tracking-tight">
                    Les établissements sont soumis à validation avant apparition sur la carte
                  </p>
                </div>
              </>
            ) : (
              <div className="p-12 md:p-16 text-center space-y-8 overflow-y-auto">
